$(document).ready(function() {
    ...
    // When the users clicks on the button, open the modal
    ...
    // Clear Data and close the modal when the users clicks on Discard button
    discardModal.onclick = function() {
        modalResetData();
        document.getElementsByTagName('body')[0].removeAttribute('style');
    }

    // Clear Data and close the modal when the users clicks on <span> (x).
    span.onclick = function() {
        modalResetData();
        document.getElementsByTagName('body')[0].removeAttribute('style');
    }

    // Clear Data and close the modal when the users clicks anywhere outside of the modal.
