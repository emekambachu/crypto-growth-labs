              ...
              '<div class="item-content">' +
                  '<div class="users-profile">' +
                      ...
                      '<div class="users-meta-info">' +
                          '<p class="users-name" data-name='+ $_nameValue +'>'+ $_nameValue +'</p>' +
                          '<p class="users-work" data-occupation='+ $_occupationValue +'>'+ $_occupationValue +'</p>' +
                      '</div>' +
                  '</div>' +
                  ...
                  '<div class="action-btn">' +
                      ...
                      '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users-minus delete"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="23" y1="11" x2="17" y2="11"></line></svg>'
                  '</div>' +
              '</div>' +
          '</div>';
...
function editContact() {
  $('.edit').on('click', function(event) {
    ...
    var $_name = getParentItem.find('.users-name');
    var $_email = getParentItem.find('.usr-email-addr');
    var $_occupation = getParentItem.find('.users-work');
